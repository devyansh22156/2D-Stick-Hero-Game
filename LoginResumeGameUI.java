...
public class LoginResumeGameUI implements LoginUI {
    ...
    public LoginResumeGameUI(Stage mainStage) throws FileNotFoundException {
    ...
    public void createRegisterButton() throws FileNotFoundException {
        ...
        registerButton.setOnAction(e -> {
            ...
            player = new Player(username, age, phoneNumber);
